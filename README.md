...
### Dashboard
> A real-time overview of your income, expenses, net savings, expense trends, and spending breakdown.

![Dashboard](screenshots/dashboard.png)

### Financial Goals
> Track your active savings goals, deadlines, targets, and remaining months at a glance.

![Financial Goals](screenshots/goals.png)

### Actionable Insights
> AI-powered savings opportunities, top spend categories, rising spend alerts, and per-goal progress cards generated by the ML pipeline.

![Actionable Insights](screenshots/actionable_insights.png)
...
4. [Asynchronous ML Processing Pipeline](#asynchronous-ml-processing-pipeline)
5. [Deep Dive: ML Features & Engines](#deep-dive-ml-features--engines)
...
> **UI context**: The endpoints below power the pages shown in the [Screenshots](#screenshots) section — `/dashboard` feeds the Dashboard view, `/transaction/list` populates the Transactions page, `/goal/list` drives the Goals view, and `/recommendations` renders the Actionable Insights page.
